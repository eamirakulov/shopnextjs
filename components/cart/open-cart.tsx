...
export default function OpenCart({
  ...
  return (
    <div className="relative flex h-12 w-12 cursor-pointer items-center justify-center bg-[#11151C] dark:bg-white rounded-none border border-neutral-200 text-black transition-colors dark:border-neutral-700 dark:text-white">
      {/* <ShoppingCartIcon
